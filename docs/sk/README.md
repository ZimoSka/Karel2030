# Karel 2010 — Dokumentácia (slovenčina)
...
- [../karxml-format.md](../karxml-format.md) — špecifikácia formátu súborov
- [../architecture.md](../architecture.md) — architektúra kódu pre vývojárov
