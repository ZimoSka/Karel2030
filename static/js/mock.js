...
const MockApi = {
  ...
  adminLogin: async (pwd) => { if (pwd === 'admin') return { ok: true }; const e = new Error('Nesprávne heslo (mock: skús „admin")'); throw e; },
  adminStatus: async () => ({ admin: false, configured: true }),
  adminLogout: async () => ({ ok: true }),
