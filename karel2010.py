...
# =========================================================================
# CORE — extrahované do karel_core/ (zdieľané jadro pre desktop aj web)
# =========================================================================
from karel_core.base import Direction, KarelError, KarelStop, KarelBudget, KarelLimit
from karel_core.missions import GoalCondition, evaluate_goals
from karel_core.world import World, WorldSettings, BUILTIN_WORLD
from karel_core.interpreter import (CMD_T, COND_T, CLOSE_T, Tok, tokenize,
    ProgN, CmdN, CallN, RepN, WhileN, IfN, CondN, NotN, AndN, OrN,
    ParseErr, Parser, parse, StopEx, KarelInterpreter)
from karel_core.samples import EXAMPLES
from karel_core.lang import (KW, _LANG_PRIMARY, _LANG_DISABLED, _LANG_NAME,
    _INTERP_LANG_DIR, _LANG_DIR, _KW_REVERSE, _primary_kw,
...
class ProgramPanel(tk.Frame):
    ...
    def _effective_disabled(self) -> set:
        ...
        return self._disabled_cmds | _LANG_DISABLED.get(current_prog_lang(), set())
    ...
    def _on_filter(self,e=None):
        ...
        if item==self._tmov:
            p = _primary_kw; L = current_prog_lang()
